...
// HTTPMaskTunnelServer bridges raw TCP accepts with the optional CDN-capable HTTP tunnel transports (xhttp/pht).
//
// Typical usage:
//
...
//   - handled=true, tunnelConn=nil for HTTP tunnel control requests (e.g., PHT push/pull)
